...
1. Clone this repository.( ```git clone https://github.com/devhau/gsc-bulk-remover``` )
...
2. If you get a [`grpc` error](https://github.com/devhau/gsc-bulk-remover/issues/612),
   [kill the
   `turbo` process](https://github.com/devhau/gsc-bulk-remover/issues/612#issuecomment-2518982339)
...
<a href="https://star-history.com/#devhau/gsc-bulk-remover&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=devhau/gsc-bulk-remover&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=devhau/gsc-bulk-remover&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=devhau/gsc-bulk-remover&type=Date" />
 </picture>
</a>
...
<a href="https://github.com/devhau/gsc-bulk-remover/graphs/contributors">
  <img width="500px" src="https://contrib.rocks/image?repo=devhau/gsc-bulk-remover" alt="All Contributors"/>
</a>
...
Made by [devhau](https://devhau.github.io/)
